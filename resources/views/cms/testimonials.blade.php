...
@extends('layouts.app',['title'=>'Testimonials'])
			...
			<div class="row">
				<div class="col-12">                            
					<section class="global-services">
						<div class="container">
							<div class="prvcy_margin"><h5>{{__('labels.what_our_learners_say') }}</h5></div>
							<div class="row">
								<div class="col-md-12 col-lg-12 wow bounceInUp" data-wow-duration="1.4s">
									<div class="desc_text_new">										
										<div id="accordion" class="one_page_canvas">
											<?php
													...
													foreach($testimonials as $testimonial) { ?>
														<div class="card">
															<div class="card-header" id="heading-<?php echo $i;?>">
																<h5 class="mb-0">
																	<a class="collapsed" role="button" data-toggle="collapse" href="#collapse-<?php echo $i;?>" aria-expanded="false" aria-controls="collapse-arps">
																		<?php
																			if(Lang::locale() == 'en') {
																		...
																		<div class="col-12">
																			<div class="desc_text_new">	
																				<p>
																					<?php
																					if(Lang::locale() == 'en') {
																						echo $testimonial->description_en;
																					} else {
																						echo $testimonial->description_ja;
																					} 
																					?>
																				</p>
																				<p>
											...
											<div class="container" style="margin-top:30px;">
												<div class="prvcy_margin"><h5>{{ __('labels.home_aspire_coaching') }}</h5></div>											
											</div>	
											
											
		
											<div class="card">
												<div class="card-header" id="aspireheading-1">
													<h5 class="mb-0">
														<a class="collapsed" role="button" data-toggle="collapse" href="#aspire-1" aria-expanded="false" aria-controls="collapse-arps">
															実践を想定したレッスンだから、上達がそのまま仕事の成果になってます。
														</a>
													</h5>
												</div>
												<div id="aspire-1" class="collapse" data-parent="#accordion" aria-labelledby="aspireheading-1">
													<div class="card-body">
														...
														<div class="row">
															<div class="col-12">
																<div class="desc_text_new">	
																<p>Q: どのようなタイミングで、自身の成長を感じましたか?</p>

<p>A: ある日、突然ですが、仕事で電話会議をしている時に、相手の会話が聞けている事にビックリしました。日々の繰り返しにより英会話のリズムに慣れてきているのだと思います。</p>
<p>Q: どのようなコーチングが実践につながっていると感じますか?</p>

<p>A: 実践では電話会議が主体であり、日々のコーチングも電話会議を前提にしています。実践に近いテーマを選び、聞く、伝える、確認するを如何に正しくコンパクトにできるかを常に意識するようになりました。</p>
<p>Q: 成長のスピードについての印象はありますか?</p>

<p>A: 英語でイメージし、そのまま英語で表現する。が、自分にとっての成長のポイントと思います。これを日々意識して繰り返す事により、段々と英語が身についてきている事を実感しています。</p>
<p>Q: ​ほかにAccentが効果的だと感じる側面はありますか?</p>

<p>A: インターネットメディアやツールを積極的に利用し、実践と変わらない環境でレッスンしてもらっています。効果的に学習できるだけでなく、インターネット特有の英語コミュニケーションも同時に学んでいます。一例ですが、詳細をURL等でリンクしたメッセージにして送る場合など、伝えたい内容のみを分かりやすくシンプルに表現する練習をしています。Accentでは、いつでもインターネットを利用してレッスンできる環境が整っています。</p>
<p>S.F.・外資系IT会社・受講6ヶ月 </p>
																</div>
															</div>
														</div>
													</div>
											...
											<div class="card">
												<div class="card-header" id="aspireheading-2">
													<h5 class="mb-0">
														<a class="collapsed" role="button" data-toggle="collapse" href="#aspire-2" aria-expanded="false" aria-controls="collapse-arps">
															実務で​英語でのディスカッション​が​​必要な方​に。
														</a>
													</h5>
												</div>
												<div id="aspire-2" class="collapse" data-parent="#accordion" aria-labelledby="aspireheading-2">
													<div class="card-body">
														...
														<div class="row">
															<div class="col-12">
																...
																<p>A: 戦略など自身の頭に中にあるイメージを、英語として正しいだけでなく、より伝わりやすい表現を選ぶことができるようになった段階で自身の成長を感じるようになりました。</p>
																<p>Q: どのようなコーチングが実践につながっていると感じますか​​?</p>

																<p>A: 日々のビジネスシーン​に合わせて、自分の考え​を英語で伝えるとともに、それに対する質問や意見​をやりとりすることで、より実践に近いトレーニングが可能になります​。 これによって、実務の場面においても臆することなく英語での発言が容易になります。</p>
																<p>Q: 成長のスピードについての印象はありますか?</p>

																<p>A: Face to Faceのセッションだけでなく、毎日の電話でのショートセッションを通じて、一貫したテーマに基づいた英語のコミュニケーションによって、間違えたところやより良い表現など早い段階で修正する機会を持つことでコミュニケーションのクオリティーが格段に上がります。</p>
																<p>Q: ​ほかにAccentが効果的だと感じる側面はありますか?</p>

																<p>A: 日常における学びや気づきなどのインプット​ををもとに、このレッスンを英語を用いたスループット​の機会として活用​することで、実際の場面での英語でのアウトプットの精度をあげること​に繋がります。</p>
																<p>F.M.・外資系IT会社・受講1年半 </p>
																</div>
															</div>
														</div>
													</div>
											...
											<div class="card">
												<div class="card-header" id="aspireheading-3">
													<h5 class="mb-0">
														<a class="collapsed" role="button" data-toggle="collapse" href="#aspire-3" aria-expanded="false" aria-controls="collapse-arps">
															英語で愚痴を言えるようになりました
														</a>
													</h5>
												</div>
												<div id="aspire-3" class="collapse" data-parent="#accordion" aria-labelledby="aspireheading-3">
													<div class="card-body">
            ...
            <p>Q: Accent LessonとAspireとの違いは？</p>
            <p>
            ...
            <p>T.Y.・外資系IT会社・受講2年半</p>
											...
											<div class="card">
												<div class="card-header" id="aspireheading-4">
													<h5 class="mb-0">
														<a class="collapsed" role="button" data-toggle="collapse" href="#aspire-4" aria-expanded="false" aria-controls="collapse-arps">
															英語力の向上を実感できる場面が必ず訪れます
														</a>
													</h5>
												</div>
												<div id="aspire-4" class="collapse" data-parent="#accordion" aria-labelledby="aspireheading-4">
													<div class="card-body">
            ...
            <p>Q.一般的な英会話教室の授業と、Aspireコーチングコースの主な違いは何か? </p>
            <p>
            ...
            <p>Q.英語を教わっているというよりは、コーチングを受けているという感じがしたか? </p>
            <p>
            ...
            <p>D.M.・外資系ワイン会社・受講18ヶ月</p>
											...
											<div class="card">
												<div class="card-header" id="aspireheading-5">
													<h5 class="mb-0">
														<a class="collapsed" role="button" data-toggle="collapse" href="#aspire-5" aria-expanded="false" aria-controls="collapse-arps">
															英語の「学習」に失敗した歴史のある方に、特におすすめしたい!
														</a>
													</h5>
												</div>
												<div id="aspire-5" class="collapse" data-parent="#accordion" aria-labelledby="aspireheading-5">
													<div class="card-body">
														...
														<div class="row">
															<div class="col-12">
																<div class="desc_text_new">	
																<p>
            Q.一般的な英会話教室の授業と、Aspireコーチングコースの主な違いは何か? </p>
            <p>
           ...
           <p> Q.あなたの仕事に関する話題を話す機会を週5日持ったことで、あなたのスピーキング(流暢さ、抑揚、発音)とリスニン グのスキルが 向上したか? </p>
            ...
            <p>H.W.・外資系IT会社・受講9ヶ月</p>
											...
											<div class="card">
												<div class="card-header" id="aspireheading-6">
													<h5 class="mb-0">
														<a class="collapsed" role="button" data-toggle="collapse" href="#aspire-6" aria-expanded="false" aria-controls="collapse-arps">
															英語が最短時間で身につく方法が計算しつくされたトレーニング
														</a>
													</h5>
												</div>
												<div id="aspire-6" class="collapse" data-parent="#accordion" aria-labelledby="aspireheading-6">
													<div class="card-body">
														...
														<div class="row">
															<div class="col-12">
																<div class="desc_text_new">	
																<p>Q. 一般的な英語の授業と、コーチングとの主な違いは何か？</p>

<p>A. コーチングの方が、授業よりも、自然に自ら主体的に学べる。コーチングによって、意欲的に英語を身につけることができる。</p>
<p>Q. 英語を教わっているというよりは、コーチングを受けているという感じがしたか？</p>

<p>A. コーチングを受けている感じがする時もあるが、コーチングによって自然に、自分でも気づかずに、英語が身についている時もたくさんある。</p>
<p>Q. コーチは、経験豊富な語学講師でありコーチであると感じたか？</p>

<p>A. はい。経験が非常に豊かな語学講師であり、コーチだ。話題をたくさん持っているため、英語での日常会話や役立つ表現をたくさん学べる。また、受講生の苦手なポイントを狙い撃ちして改善してくれるので、英語の力が効果的に、飛躍的に向上できる。優秀な講師・コーチでなかったら、こういう指導はできない。</p>
<p>Q. あなたが仕事で使用する英語に関連する役立つ語彙やフレーズをコーチは提案してくれたか？</p>

<p>A. はい。私が仕事柄使う英語のフレーズや、日常会話で使えるフレーズをコーチはたくさん教えてくれた。</p>
<p>Q. あなたの仕事に関する話題を話す機会を週5日持ったことで、あなたのスピーキング（流暢さ、抑揚、発音）とリスニングのスキルが向上したか？</p>

<p>A. はい。私の場合は、特にスピーキングのスキルが向上した。リスニングは、あまりに早い英会話はまだ聞き取りにくいが、Aspireで学ぶ前に比べれば、断然スキルアップした。これらばかりでなく、最も効果があったのは、英語への苦手意識が大幅に減ったことだ。</p>
<p>Q. コースにおいて何が向上すると思うか？</p>

<p>A. 1. 英語を聞き、英語で考え、英語で話すことが向上する 2. その人が最も英語を使う場面（例えば私の場合ならビジネス）で使える英語の表現が向上する 3. 英語を効果的に学ぶための様々な工夫ができるようになる</p>
<p>Q. Aspireのビジネスコミュニケーションコーチングを他の人にもすすめたいか？</p>

<p>A. はい、もちろん！Aspireのコーチは、英語・日本語といった言語に精通しているだけでなく、神経言語学にも精通している。したがって、ただの英語の授業ではなく、英語と日本語の言語や文化の違いを理解し、どう考えたら英語が最短時間で身につくか？が計算されたトレーニングを受けることができる。また、コーチングスキルも非常に高い。その人が理解しやすいように、その人が自発的に取り組んでいくように、様々なコーチングスキルを駆使している。これから英語のビジネスコミュニケーションを学びたい人には、ぜひお勧めする。</p>
<p>H.T.・外資系IT会社・受講6ヶ月</p>
																</div>
															</div>
														</div>
													</div>
											...
											<div class="card">
												<div class="card-header" id="aspireheading-7">
													<h5 class="mb-0">
														<a class="collapsed" role="button" data-toggle="collapse" href="#aspire-7" aria-expanded="false" aria-controls="collapse-arps">
															聞く、話す、読む、書く、すべての英語力が向上
														</a>
													</h5>
												</div>
												<div id="aspire-7" class="collapse" data-parent="#accordion" aria-labelledby="aspireheading-7">
													<div class="card-body">
            ...
            <p>I.K.・外資系IT会社・受講12ヶ月</p>
											...
											<div class="card">
												<div class="card-header" id="aspireheading-8">
													<h5 class="mb-0">
														<a class="collapsed" role="button" data-toggle="collapse" href="#aspire-8" aria-expanded="false" aria-controls="collapse-arps">
															英語力はもちろん、プレゼンスキルも身につく
														</a>
													</h5>
												</div>
												<div id="aspire-8" class="collapse" data-parent="#accordion" aria-labelledby="aspireheading-8">
													<div class="card-body">
           ...
           <p> Q: コースにおいて何が向上すると思うか？</p>
            ...
            <p>K.N.・外資系IT会社・受講3ヶ月</p>
											...
											<div class="card">
												<div class="card-header" id="aspireheading-9">
													<h5 class="mb-0">
														<a class="collapsed" role="button" data-toggle="collapse" href="#aspire-9" aria-expanded="false" aria-controls="collapse-arps">
															海外の顧客とのコミュニケーションがスムーズに！
														</a>
													</h5>
												</div>
												<div id="aspire-9" class="collapse" data-parent="#accordion" aria-labelledby="aspireheading-9">
													<div class="card-body">
            ...
            <p>R.N.・海外事業部・インテリアメーカー・受講6ヶ月</p>
											...
											<div class="card">
												<div class="card-header" id="aspireheading-10">
													<h5 class="mb-0">
														<a class="collapsed" role="button" data-toggle="collapse" href="#aspire-10" aria-expanded="false" aria-controls="collapse-arps">
															突然のNY勤務。コーチングがあってよかった！
														</a>
													</h5>
												</div>
												<div id="aspire-10" class="collapse" data-parent="#accordion" aria-labelledby="aspireheading-10">
													<div class="card-body">
