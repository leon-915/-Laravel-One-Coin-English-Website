...
@section('title')
		<title> Translation Job bid rejected </title>
@endsection
@section('content')
    <h1 style="font-size: 25px; color: #212529; font-weight: 500; margin: 0; padding: 20px 0;"> Translation Job bid rejected</h1>
            ...
            <tbody>
				<tr style=" font-size: 14px; color: #353535;">
                    <td colspan="2" style="text-align: center;">
                        Your bid on translation job has been rejected.
						<b><a href="{{ route('teachers.job.history',) }}">Click here to view the job</a></b>
                    </td>
                </tr>
                <tr style=" font-size: 14px; color: #353535;">
