...
@section('title')
		<title> Translation Job bid accepted </title>
@endsection
@section('content')
    <h1 style="font-size: 25px; color: #212529; font-weight: 500; margin: 0; padding: 20px 0;"> Translation Job bid accepted</h1>
            ...
            <tbody>
				<tr style=" font-size: 14px; color: #353535;">
                    <td colspan="2" style="text-align: center;">
                        Your bid on translation job has been accpted.
