...
@endsection
@section('content')
    <h1 style="font-size: 25px; color: #212529; font-weight: 500; margin: 0; padding: 20px 0;"> Translation Job accepted</h1>
            ...
            <tbody>
				<tr style=" font-size: 14px; color: #353535;">
                    <td colspan="2" style="text-align: center;">
                        Your translation job has been accpted by teacher.
						<b><a href="{{ route('students.post.job.historyDetail', ['id'=> $data['id']]) }}">Click here to view the job</a></b>
                    </td>
                </tr>
                <tr style=" font-size: 14px; color: #353535;">
