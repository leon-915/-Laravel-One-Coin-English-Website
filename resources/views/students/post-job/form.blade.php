                    ...
                    <div class="profile_inner tab_pnle_sec">
                        <div class="card custome_nav">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation"><a href="#createjob" aria-controls="createjob" role="tab"
                                                           data-toggle="tab" class="active"> <span>{{__('labels.stu_create_job')}}</span></a>
                                </li>
                                <li role="presentation"><a
                                            href="{{route('students.post.job.history')}}"><span>{{__('labels.stu_history')}}</span></a></li>
                            </ul>

                            <!-- Tab panes -->
                            <div class="tab-content">
                                <div role="tabpane1" class="tab-pane active" id="createjob">
                                    @include('students.post-job.tabs.jobform')
                                </div>
                            </div>
                        </div>
                    </div>
