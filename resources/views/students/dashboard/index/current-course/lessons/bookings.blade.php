...
<div class="service_session">
    <div class="row">
        @foreach($lesson['bookings'] as $bid => $booking)
        <?php
        ...
        ?>
            <div class="col-12 col-md-12 col-lg-12 reserv-detail">
                <div class="service_session_details">
                    <div class="s-hd">
                        <p> 
                            <a href="JavaScript:void(0);" data-toggle="tooltip" data-trigger="hover" title="{{$lesson['service']['title']}}">{{$lesson['service']['title']}}</a>
                        </p>
                        @if(($booking['status'] == 'booked') && ($button))
    ...
    <div class="row">
        <div class="col-12 current-course-pagination" data-lesson_id="{{ $lesson['id'] }}" data-service="{{$lesson['service']['id']}}" id="c-paginator-{{ $lesson['id'] }}">
            {{ $lesson['bookings']->links() }}
        </div>
    </div>
</div>
