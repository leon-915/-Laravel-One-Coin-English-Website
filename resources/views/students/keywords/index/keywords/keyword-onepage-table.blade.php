<div class="row">
    <div class="col-12">
        ...
        <div class="table-responsive keyword_table table-inner-container">
            <table class="table" id="keyword-onepage-table" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th scope="col">{{__('labels.stu_topic_jp')}}</th>
                        <th scope="col">{{__('labels.stu_student')}}</th>
                        <th scope="col">{{__('labels.stu_action')}}</th>
                    </tr>
                </thead>
            </table>
        </div>
...
<script>
    ...
    KOTable = $('#keyword-onepage-table').DataTable({
        ...
        ajax: {
            url: '<?= route("students.get.keywordonepage.list") ?>',
            type: 'POST',
