...
<div style="background:#000; padding:20px; text-align:center;">
    <img class="brand_icon" style="width:75px" src="{{$image}}" alt="logo" />
</div>
<div style="align:center; border:1px solid #ccc; padding-top:30px; padding-bottom:40px">
    ...
    <div class="wrapper" style="text-align:left;font-size:18px;margin: 0 auto; width: 750px;">
        ...
        <p> Your Invoice has been created for next month. Please Check attachment.</p>
...
@section('content')
    <h1 style="font-size: 25px;  color: #212529;  font-weight: 500;  margin: 0;  padding: 20px 0;">New Invoice Message</h1>
    <div class="course" style="padding-bottom: 25px;">
        <h3 style="color: #484848; font-size: 18px; margin-bottom: 0; font-weight: 700;"> Hi {{$user->first_name}}, </h3>
        <p> Your Invoice has been created for next month. Please Check attachment.</p>
    </div>
@endsection
