...
?>
    <div class="content-wrapper ">
        <div class="page-header">
            <h3 class="page-title">Lesson Amount Reports</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ $url }}">{{ __('labels.dashboard') }}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Lesson Amount Reports</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card">
            <div class="admin_date_sec">
                @include('admin.reports.amount.go_search')
            </div>
        </div>
    </div>
        ...
        <script>
            ...
            var bar_chart2 =  {
                    ...
                    data: {
                        ...
                        datasets: [
                            {
                                label: "<?= in_array($option,['total_hours_taught_by_teachers','total_hours_taught_per_teacher']) ? 'Hour' : 'Amount(¥)' ?>",
