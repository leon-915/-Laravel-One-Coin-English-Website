...
?>
    ...
    <div class="content-wrapper ">
        <div class="page-header">
            <h3 class="page-title">Lesson Rating Reports</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ $url }}">{{ __('labels.dashboard') }}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Lesson Rating Reports</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card">
            <div class="admin_date_sec">
                @include('admin.reports.ratings.go_search')
            </div>
        </div>
    </div>
