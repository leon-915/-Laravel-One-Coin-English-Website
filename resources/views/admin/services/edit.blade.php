@extends('admin.layouts.admin',['title'=>'Edit Service'])
...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title"> {{ __('labels.edit_service')}} </h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('labels.edit_service')}}</li>
                </ol>
            </nav>
        </div>
        <div class="row grid-margin">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{ __('labels.edit_service')}}</h4>
                        ...
                        {!! Form::model($services, ['method' => 'PATCH', 'class'=>'cmxform', 'id'=>'edit_service','route' => ['admin.services.update', $services->id],'autocomplete' => "off","enctype"=>"multipart/form-data"]) !!}
                        <fieldset>
                            @include('admin.services.form',['form' => 'edit'])
                        </fieldset>
                        {!! Form::close() !!}
    ...
    @push('scripts')
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                @if(empty($services->flexible_appointment_start_time))
                ...
                @if(empty($services->prepayment_type))
                ...
                //is_available in trial hide/show
                /*if($('#package_id').val()){
            ...
            $(document).ready(function () {
                @if($services->is_system_service == 1)
...
/*          $(document).ready(function () {
              var booking_type = $('#receive_credit_on_booking_type').val();
